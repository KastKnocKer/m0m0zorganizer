	...
	public static void main(String[] args) {
		...
		while (DatabaseMySql.getCount("utenti", "popToCheck") != 0) {
			try {			
				...
				flagEth = !flagEth;
				OutputTxt.writeLog("Padre: Popular scansionati   totale: " + DatabaseMySql.getCount("utenti", "profile"));
				OutputTxt.writeLog("Padre: Popular scansionati   attivi: " + DatabaseMySql.eseguiQuery("Select count(*) from utenti.profile where status='active'").get(0)[0]);
			}
			catch (IOException e) {
