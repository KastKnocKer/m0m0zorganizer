...
public class DatabaseMySql {
	...
	public DatabaseMySql(String nomeDB){
		...
		db = new Database(nomeDB ,"root","root");
		db.setPublicHost("127.0.0.1:3306");
	}
	...
	public static boolean delete (String nomeDB, String lista, String col1, String values1, String col2, String values2, String col3, String values3) {
		return db.eseguiAggiornamento("delete from " + nomeDB + "." + lista + " where " + 
				col1 + "= '" + values1 + "' and " + col2 + "= '" + values2 + "' and " + col3 + "= '" + values3 + "'");
	}
	
	public static boolean delete (String nomeDB, String lista, String col1, String values1, String col2, String values2, String col3, String values3, String col4, String values4) {
		return db.eseguiAggiornamento("delete from " + nomeDB + "." + lista + " where " + 
				col1 + "= '" + values1 + "' and " + col2 + "= '" + values2 + 
				"' and " + col3 + "= '" + values3 + "' and " + col4 + "= '" + values4 + "'");
	}
	
	
	public static String[] extract (String nomeDB, String lista, String col1) {
		String[] user; 		
		try {
			user =  (DatabaseMySql.eseguiQuery("Select * from " + nomeDB + "." + lista + " limit 1")).get(0);
			DatabaseMySql.delete (nomeDB, lista, col1, user[0]);
		} catch (ArrayIndexOutOfBoundsException e) {
	...
	public static String[] extract (String nomeDB, String lista, String col1, String col2 ) {
		String[] user; 		
		try {
			user =  (DatabaseMySql.eseguiQuery("Select * from " + nomeDB + "." + lista + " limit 1")).get(0);
			DatabaseMySql.delete (nomeDB, lista, col1, user[0], col2, user[1]);
		} catch (ArrayIndexOutOfBoundsException e) {
		//	OutputTxt.writeException(nomeDB, e.getLocalizedMessage());
		//	OutputTxt.writeLog(nomeDB, "Lista " + lista + " analizzata conclusa.");
			return null;
	...
	public static String[] extract (String nomeDB, String lista, String col1, String col2 , String col3) {
		String[] user; 		
		try {
			user =  (DatabaseMySql.eseguiQuery("Select * from " + nomeDB + "." + lista + " limit 1")).get(0);
			DatabaseMySql.delete (nomeDB, lista, col1, user[0], col2, user[1], col3, user[2]);
		} catch (ArrayIndexOutOfBoundsException e) {
		//	OutputTxt.writeException(nomeDB, e.getLocalizedMessage());
		//	OutputTxt.writeLog(nomeDB, "Lista " + lista + " analizzata conclusa.");
			return null;
	...
	public static String[] extract (String nomeDB, String lista, String col1, String col2 , String col3 , String col4) {
		String[] user; 		
		try {
			user =  (DatabaseMySql.eseguiQuery("Select * from " + nomeDB + "." + lista + " limit 1")).get(0);
			DatabaseMySql.delete (nomeDB, lista, col1, user[0], col2, user[1], col3, user[2], col4, user[3]);
		} catch (ArrayIndexOutOfBoundsException e) {
		//	OutputTxt.writeException(nomeDB, e.getLocalizedMessage());
		//	OutputTxt.writeLog(nomeDB, "Lista " + lista + " analizzata conclusa.");
			return null;
