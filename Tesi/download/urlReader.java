...
public class urlReader  {
    ...
    public static void favoritesReader (String user) {
    	favoritesReader(user , 1);
    }
    
    public static void favoritesReader (String user, int count) {
    	System.out.println("Favorites reader dell'utente: " + user);
    	String inputLine, id, published;
