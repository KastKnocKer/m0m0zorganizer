...
import download.scanCorrupted;
	...
	// Processo per l'analisi degli utenti risultati come corrupted al termine della scansione statica
public class crawlerCorrupted {
	...
	public static void main(String[] args) {		
		...
		new scanCorrupted(myService, DatabaseMySql.eseguiQuery("Select devKey from root.key where crawler='"+ args[0] + "'").get(0)[0], args[1]);
