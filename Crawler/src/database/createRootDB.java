...
public class createRootDB {
	...
	public createRootDB () {
		...
		DatabaseMySql.eseguiAggiornamento("create table root.videoChecked 	 (user Char(20), id Char(11), published char(19), numRaters char(10), favoriteCount char(10), viewCount char(10), PRIMARY KEY(user, id))");
		...
		DatabaseMySql.eseguiAggiornamento("create table root.ethernet 	     (rete Char(6), flag char(5), PRIMARY KEY (rete))");
		
		DatabaseMySql.insert("root", "config", "figlio", "user", "off");
