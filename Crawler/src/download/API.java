...
import java.net.URL;
  ...
  public class API {
	...
	// Funzione per ottenere le informazioni del profilo dell'utente specificato
	...
	// Funzione per ottenere le informazioni dell'elenco favoriti dell'utente specificato
	...
	// Funzione per ottenere il numero di video condivisi da un determinato utente
	...
	// Funzione per ottenere le informazioni dei video condivisi dall'utente specificato come parametro
	...
	// Funzione per ottenere le attività relative all'utente specificato
	...
	// Funzione per ottenere le subscriptions relative all'utente specificato
	...
	// Funzione per gestire l'errore di flood dovuto alle richieste verso le API
	...
	// Funzione per gestire gli errori HTTP legati alle richieste verso le DATA API
